...
def main(_):
    ...
    network,  lstm2 = inference(input_data, is_training=True, num_steps=num_steps, reuse=None)
    # Inference for Validating
    network_val, lstm2_val = inference(input_data, is_training=False, num_steps=num_steps, reuse=True)
    ...
    for i in range(max_max_epoch):
        ...
        for step, (x, y) in enumerate(next_batch(train_data_x, train_data_y,
            ...
            # 训练 ！！！！！！！！
            _cost, _acc,  state2, _ = sess.run([cost,
                                                       acc,
        ...
        for step, (x, y) in enumerate(next_batch(test_data_x, test_data_y,
            ...
            _cost, _acc,state2 = sess.run([cost_val,
                                                    acc_val,
